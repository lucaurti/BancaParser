...
#sudo docker run -d -p 5600:8080 -v /home/luclash/dati/findduplicate/:/FindDuplicate.Business.ApiHost/Volume_FindDuplicate_Business_ApiHost/ --name banca_parser_business_apihost_container -e ASPNETCORE_ENVIRONMENT='server_docker' -e TZ=Europe/Paris --restart unless-stopped -t banca_parser_business_apihost_container_image
sudo docker run -d -p 5600:8080 -v /media/hd/dati500gb/bancaparser/:/BancaParser.ApiHost/Volume_BancaParser_Host/ --name banca_parser_business_apihost_container -e ASPNETCORE_ENVIRONMENT='server_docker' -e TZ=Europe/Paris --restart unless-stopped -t banca_parser_business_apihost_container_image
#sudo docker run -d -p 5600:8080 -v /media/hd/dati/findduplicate/:/FindDuplicate.Business.ApiHost/Volume_FindDuplicate_Business_ApiHost/ --name banca_parser_business_apihost_container -e ASPNETCORE_ENVIRONMENT='server_docker' -e TZ=Europe/Paris --restart unless-stopped -t banca_parser_business_apihost_container_image
#sleep 1.5
